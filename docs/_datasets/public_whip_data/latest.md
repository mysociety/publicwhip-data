...
custom:
  ...
  change_log:
    ...
    0.5.1: 'Minor change in data for resource(s): pw_division,pw_moffice'
    0.6.0: 'Change in data for resource(s): pw_moffice,pw_mp,pw_vote'
    ...
    0.9.1: 'Minor change in data for resource(s): pw_moffice'
    0.9.2: 'Minor change in data for resource(s): pw_moffice'
    0.9.3: 'Minor change in data for resource(s): pw_moffice'
resources:
- title: Divisions
  ...
  schema:
    ...
    - name: responsibility
      ...
      constraints:
        ...
        - ''
      example: ''
  hash: 869a1e67ceb45bf19e3fba74aaa986b1
